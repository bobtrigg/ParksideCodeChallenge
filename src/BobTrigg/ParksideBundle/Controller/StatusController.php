...
use BobTrigg\ParksideBundle\Entity\Status;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $statuses = $em->getRepository('BobTriggParksideBundle:Status')->findAll();
    ...
    {
        $status = new Status();
        $form = $this->createForm('BobTrigg\ParksideBundle\Form\StatusType', $status);
    ...
    {
        $deleteForm = $this->createDeleteForm($status);
        $editForm = $this->createForm('BobTrigg\ParksideBundle\Form\StatusType', $status);
